  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        // For group mode, load all member ids for permission checks
      ...
      <div className="sl-root">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: ".73rem", color: "var(--muted)" }}>
                {mode === "friend" ? "Direct expenses" : "Group expenses"}
              </div>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="sl-empty-state" style={{ marginTop: 80 }}>
            ...
            <Link to="/expense/new" className="btn btn-accent" style={{ marginTop: 8 }}>+ Add expense</Link>
          </div>
        ) : (
            ...
            <nav className="sl-sidebar">
              <div className="sl-sidebar-scroll">
                <div className="sl-section-label">
                  {mode === "friend" ? `Sets with ${contextName}` : "Participant sets"}
                </div>
            ...
            <div className="sl-panel">
              {selectedSet ? (
                <div className="sl-panel-inner">
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: ".82rem", color: "var(--muted)", marginTop: 3 }}>
                      {selectedSet.count} expense{selectedSet.count !== 1 ? "s" : ""}
                  ...
                  {/* expense list */}
                  <div>
                    <div style={{ fontSize: ".72rem", fontWeight: 600, color: "var(--muted)", textTransform: "uppercase", letterSpacing: ".07em", marginBottom: 10 }}>Expenses</div>
                        ...
                        .map((expense) => (
                          <div key={expense.id} className="sl-exp-item">
                            <div className="sl-paid-by">
                              ...
                              {expense.createdAt && <span style={{ marginLeft: 8 }}>{relativeTime(expense.createdAt)}</span>}
                            </div>
                            <ExpenseDetailCard
                              expense={expense}
                              currentUserId={myId}
                ...
                <div className="sl-empty-state">
                  <span className="icon">👈</span>
                  <p>Select a participant set to see expenses</p>
                </div>
              )}
            </div>
          </div>
